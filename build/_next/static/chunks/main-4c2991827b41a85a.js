      ...
      class Y {
        ...
        async change(e, t, r, n, o) {
          ...
          this._inFlightRoute &&
            this.clc &&
            (q ||
              Y.events.emit("routeChangeError", L(), this._inFlightRoute, Q),
            this.clc(),
            (this.clc = null)),
            (r = (0, R.addBasePath)(
              (0, b.addLocale)(
          ...
          if (!B && this.onlyAHashChange(J) && !Z) {
            (W.asPath = J),
              Y.events.emit("hashChangeStart", r, Q),
            ...
            try {
              ...
              throw (
                ((0, l.default)(e) &&
                  e.cancelled &&
                  Y.events.emit("routeChangeError", e, J, Q),
                e)
              );
            }
            return Y.events.emit("hashChangeComplete", r, Q), !0;
          }
          ...
          B || Y.events.emit("routeChangeStart", r, Q);
          ...
          try {
            ...
            if (
              ...
              if (
                ((W.isPreview = !!a.props.__N_PREVIEW), a.props.notFound === X)
              ) {
                let e;
                try {
            ...
            if (
              (Y.events.emit("beforeHistoryChange", r, Q),
              ...
              if (a.error)
                throw (
                  (B || Y.events.emit("routeChangeError", a.error, J, Q),
                  a.error)
                );
              B || Y.events.emit("routeChangeComplete", r, Q),
